      ...
      <div className="max-w-xl mx-auto text-center">
        ...
        >
          <input
            ...
            required
            className="flex-1 bg-charcoal border border-gold/20 px-6 py-4 text-ivory font-body text-sm tracking-wide placeholder:text-smoke/50 focus:border-gold focus:outline-none transition-colors"
          />
          <button
            type="submit"
            className="bg-gold text-black px-8 py-4 text-xs tracking-[0.3em] uppercase font-body font-medium hover:bg-gold-light transition-colors shrink-0"
          >
            Subscribe
          </button>
        </motion.form>
        ...
        <motion.p
          ...
          className="text-smoke/40 text-xs mt-4"
        >
